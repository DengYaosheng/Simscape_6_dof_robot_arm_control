...
L1 = Link([0    111.5    0            0        0    0],'modified'); 
L2 = Link([0       0     0         pi/2      0    -pi/2],'modified');
L3 = Link([0       0    -270       0        0    0],'modified');
L4 = Link([0    149   -248       0        0     -pi/2],'modified');
L5 = Link([0    100      0          pi/2     0    0],'modified');
L6 = Link([0    105      0         -pi/2     0    0],'modified');
